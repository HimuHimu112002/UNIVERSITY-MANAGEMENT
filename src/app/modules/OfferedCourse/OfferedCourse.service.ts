...
const createOfferedCourseIntoDB = async (payload: TOfferedCourse) => {
  ...
  const isAcademicFacultyExits =
    await FacultyModel.findById(academicFaculty);
  ...
  const isAcademicDepartmentExits =
    await AcademicDepartmentyModel.findById(academicDepartment);
  ...
  const isDepartmentBelongToFaculty = await AcademicDepartmentyModel.findOne({
